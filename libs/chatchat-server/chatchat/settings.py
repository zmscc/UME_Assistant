...
class BasicSettings(BaseFileSettings):
    ...
    KB_ROOT_PATH: str = str(CHATCHAT_ROOT / "data/knowledge_base") # todo 原
    # KB_ROOT_PATH: str = "mysql+pymysql://root:123@192.168.150.101:3306"
    """知识库默认存储路径"""
    ...
    API_SERVER: dict = {"host": DEFAULT_BIND_HOST, "port": 7861, "public_host": "127.0.0.1", "public_port": 7861}  # todo 原
    # API_SERVER: dict = {"host": DEFAULT_BIND_HOST, "port": 7861, "public_host": "192.168.150.101", "public_port": 19530}
